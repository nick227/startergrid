...
export const platformProfiles: PlatformProfileSeed[] = [
  ...
  },
  {
    ...
    submissionMethods: ['FEED_URL', 'OAUTH', 'MOCK_FORM'],
    sourceUrls: [
  ...
  },
  {
    ...
    name: 'TikTok Shop',
    kind: 'MARKETPLACE',
    schemaVersion: 'docs-2026.06-tiktok-shop-v202309',
    lastVerifiedAt: '2026-06-09T00:00:00.000Z',
    profileConfidence: 'HIGH',
    needsReview: false,
    sourceNote: 'TikTok Shop Open API v202309 — product catalog for in-app shopping. Separate app/OAuth from TikTok Ads. App registered at partner.tiktokshop.com.',
    mockEndpoint: 'mock://platform/tiktok-shop',
    integrationUrls: {
      partnerPortalUrl: 'https://seller.tiktok.com/',
      developerDocsUrl: 'https://partner.tiktokshop.com/docv2/page/product',
      feedSpecUrl: 'https://partner.tiktokshop.com/docv2/page/product-create',
      apiBaseUrl: 'https://open-api.tiktok-shops.com/',
      supportUrl: 'https://seller-support.tiktok.com/',
      notes: 'Products listed in TikTok\'s native in-app shop — visible on For You Page, Live Shopping, and Shop tab. Separate Seller Center account and app credentials (TIKTOK_SHOP_APP_KEY / TIKTOK_SHOP_APP_SECRET) required. Category ID defaults to automotive; verify against /product/202309/categories for the active region.'
    },
    outputFormat: 'TIKTOK_SHOP_PRODUCT_API',
    submissionMethods: ['OAUTH', 'MOCK_API'],
    sourceUrls: [
      'https://partner.tiktokshop.com/docv2/page/product',
      'https://partner.tiktokshop.com/docv2/page/product-create',
      'https://auth.tiktok-shops.com/',
    ],
    requiredDealershipFields: ['legalName', 'websiteUrl', 'primaryContact.email'],
    supportedCategories: ['AUTOMOTIVE'],
    requiredVehicleFields: [
      'stockNumber', 'year', 'make', 'model', 'priceCents', 'condition',
      'exteriorColor', 'media[0].url'
    ],
    requiredMediaRules: { minImages: 1, minWidth: 300, minHeight: 300, preferredWidth: 800, preferredHeight: 800 },
    testFixtures: { validatesFeed: true, supportsReferralCredit: false, requiresDealerAccount: true },
    connectionFields: [
      { field: 'accountId', label: 'TikTok Shop ID', hint: 'Seller Center → Shop Management → Shop ID', placeholder: '7300000000000000001', helpUrl: 'https://seller.tiktok.com/' },
      { field: 'membershipStatus', label: 'Shop Status', placeholder: 'Active / Under Review / Suspended' },
      { field: 'platformRepName', label: 'TikTok Shop Manager' },
      { field: 'platformRepEmail', label: 'Manager Email' },
    ],
  ...
  },
  {
    ...
    connectionFields: [
      { field: 'accountId', label: 'CRM ADF/XML Endpoint', hint: 'CRM-provided inbound email address or webhook URL for ADF lead delivery', placeholder: 'leads@crm-provider.com' },
      { field: 'membershipStatus', label: 'CRM Platform', placeholder: 'VinSolutions / DealerSocket / Elead / DealerTrack / Reynolds' },
  ...
  },
  {
    ...
    connectionFields: [
      { field: 'accountId', label: 'Apple Maps Place ID', hint: 'From Apple Business Connect portal or Maps location record', placeholder: 'I12345678901234567' },
      { field: 'membershipStatus', label: 'Location Verification Status', placeholder: 'Verified / Pending / Unverified' },
  ...
  },
  {
    ...
    submissionMethods: ['FEED_URL', 'OAUTH', 'MOCK_API'],
    sourceUrls: [],
    requiredDealershipFields: ['legalName', 'websiteUrl', 'primaryContact.email'],
  ...
  },
  {
    ...
    kind: 'SOCIAL_CATALOG',
    schemaVersion: 'stub-2026.06-facebook-business-page',
    lastVerifiedAt: '2026-06-09T00:00:00.000Z',
    profileConfidence: 'MEDIUM',
    needsReview: false,
    sourceNote: 'Page-posting channel. Uses the Pages API to post vehicle listings directly to a connected Facebook Business Page. Separate OAuth flow from catalog/ads (different scopes, different token row).',
    mockEndpoint: 'mock://platform/facebook-business-page',
    integrationUrls: {
      partnerPortalUrl: 'https://www.facebook.com/pages/',
      developerDocsUrl: 'https://developers.facebook.com/docs/pages-api',
      notes: 'Requires pages_show_list + pages_manage_posts. Page access tokens are derived from the user token returned by OAuth.',
    },
    outputFormat: 'FACEBOOK_PAGE_POST',
    submissionMethods: ['OAUTH'],
    sourceUrls: ['https://developers.facebook.com/docs/pages-api/posts'],
    requiredDealershipFields: ['legalName', 'primaryContact.email'],
    supportedCategories: ['AUTOMOTIVE'],
    requiredVehicleFields: ['stockNumber', 'year', 'make', 'model', 'priceCents', 'media[0].url'],
    requiredMediaRules: { minImages: 1 },
  ...
  },
  {
    ...
    kind: 'SOCIAL_CATALOG',
    schemaVersion: 'stub-2026.06-google-business-profile',
    lastVerifiedAt: '2026-06-09T00:00:00.000Z',
    profileConfidence: 'MEDIUM',
    needsReview: false,
    sourceNote: 'Local posting channel. Uses the Google Business Profile API to create local posts (vehicle listings) on a connected GBP location. Separate OAuth flow from Google Vehicle Ads/Merchant Center (different scopes, different token row).',
    mockEndpoint: 'mock://platform/google-business-profile',
    integrationUrls: {
      partnerPortalUrl: 'https://business.google.com/',
      developerDocsUrl: 'https://developers.google.com/my-business/reference/rest',
      notes: 'Requires business.manage scope. Location resource name stored as pageId in SocialPageAccount; access token always fetched fresh from CredentialStore at publish time.',
    },
    outputFormat: 'GBP_LOCAL_POST',
    submissionMethods: ['OAUTH'],
    sourceUrls: ['https://developers.google.com/my-business/reference/rest/v4/accounts.locations.localPosts'],
    requiredDealershipFields: ['legalName', 'primaryContact.email'],
    supportedCategories: ['AUTOMOTIVE'],
    requiredVehicleFields: ['stockNumber', 'year', 'make', 'model', 'priceCents', 'media[0].url'],
    requiredMediaRules: { minImages: 1 },
