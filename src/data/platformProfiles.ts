...
export const platformProfiles: PlatformProfileSeed[] = [
  // ── Owned channel ────────────────────────────────────────────────────────
  {
    ...
    supportedCategories: ['AUTOMOTIVE', 'TRAILERS_POWERSPORTS_RV'],
  ...
  },
  {
    ...
    profileConfidence: 'MEDIUM',
    needsReview: false,
    sourceNote: 'Stub profile for non-automotive Facebook Marketplace catalog feeds (RV, trailer, powersports inventory).',
