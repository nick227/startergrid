// Seed helper — creates one SUPER_ADMIN OperatorAccount for dev/staging use.
//
...
// intentionally weak and for local development only — set SEED_ADMIN_PASSWORD
// to something strong in any shared or internet-facing environment.
