...
import { createAuthorizationPacket } from '../publishing/packetGenerator.js';
import { writeMockEmail } from '../dealer/mockEmailService.js';
import { writeMockReceipt } from '../publishing/mockReceiptService.js';
