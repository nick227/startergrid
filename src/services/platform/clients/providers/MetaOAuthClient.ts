...
export class MetaOAuthClient extends OAuthClient {
  readonly provider: OAuthProvider = 'meta';
  ...
  protected readonly clientId = process.env['META_CLIENT_ID'] ?? '';
  protected readonly clientSecret = process.env['META_CLIENT_SECRET'] ?? '';
