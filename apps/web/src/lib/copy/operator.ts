...
export const operatorCopy = {
  ...
  platforms: {
    ...
    viewQueueForPlatform: 'View queue',
  ...
  queue: {
    title: 'Queue',
    controlCenterTitle: 'Publishing control center',
    subtitle: 'What is going out, where, and when — approve, hold, or publish now.',
    ...
    whenDueNow: 'Due now',
    whenAfterApproval: 'After approval',
    whenOnHold: 'On hold',
    whenManual: 'When dispatched manually',
    whenRetryDue: 'Retry due',
    whenSending: 'Sending now',
    whenOverdue: 'Overdue',
    whenBatchPending: 'Batch time pending',
    sendNow: 'Send now',
