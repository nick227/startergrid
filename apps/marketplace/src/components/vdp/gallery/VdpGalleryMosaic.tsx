  ...
  return (
    <section aria-label="Vehicle gallery">
      <div className="grid grid-cols-4 grid-rows-4 gap-2">
        <MosaicCell label={hero!.label} item={hero!.item} alt={alt} className="col-span-2 row-span-2 min-h-[220px]" onOpen={() => hero!.item && onOpenItem(hero!.item.id)} />
        <MosaicCell label={s2!.label} item={s2!.item} alt={alt} className="min-h-[104px]" onOpen={() => s2!.item && onOpenItem(s2!.item.id)} />
        <MosaicCell label={s3!.label} item={s3!.item} alt={alt} className="min-h-[104px]" onOpen={() => s3!.item && onOpenItem(s3!.item.id)} />
        <MosaicCell label={s4!.label} item={s4!.item} alt={alt} className="min-h-[104px]" onOpen={() => s4!.item && onOpenItem(s4!.item.id)} />
        <MosaicCell label={s5!.label} item={s5!.item} alt={alt} className="min-h-[104px]" onOpen={() => s5!.item && onOpenItem(s5!.item.id)} />
        <MosaicCell label={s6!.label} item={s6!.item} alt={alt} className="min-h-[96px]" onOpen={() => s6!.item && onOpenItem(s6!.item.id)} />
        <MosaicCell label={s7!.label} item={s7!.item} alt={alt} className="min-h-[96px]" onOpen={() => s7!.item && onOpenItem(s7!.item.id)} />
        <MosaicCell label={s8!.label} item={s8!.item} alt={alt} className="min-h-[96px]" onOpen={() => s8!.item && onOpenItem(s8!.item.id)} />
        <MosaicCell label={s9!.label} item={s9!.item} alt={alt} className="min-h-[96px]" onOpen={() => s9!.item && onOpenItem(s9!.item.id)} />
        <MosaicCell label={s10!.label} item={s10!.item} alt={alt} className="col-span-4 min-h-[88px]" onOpen={() => s10!.item && onOpenItem(s10!.item.id)} />
      </div>
