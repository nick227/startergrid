...
export const content: SplashContent = {
  meta: {
    title: 'ApparelGrid — Easy Inventory Management for Clothing Brands',
    description:
      'ApparelGrid connects your inventory software to all your online listing sites automatically. See which sites sell your clothes and stop updating listings by hand.',
  },
  brand: {
    name: 'ApparelGrid',
    tagline: 'Simple inventory automation for apparel brands',
    accentColor: '#f43f5e', // rose-500
    accentColorDark: '#be123c', // rose-700
    accentColorLight: '#ffe4e6', // rose-100
    accentColorGlow: 'rgba(244, 63, 94, 0.18)',
  },
  audience: {
    label: 'brands',
    industry: 'apparel',
  ...
  block1_hero: {
    ...
    headline: 'Get your clothing online fast. We handle the rest.',
    subheadline:
      'ApparelGrid connects your inventory software directly to the sites where you sell apparel. When an item arrives, it is listed automatically. When it sells out, it is removed everywhere. No manual updates required.',
  ...
  block2_pain: {
    ...
    subheading:
      'Entering SKUs, sizes, colors, and photos across multiple websites takes too much time, and making sure your listings are accurate is a constant headache.',
    painPoints: [
      {
        icon: '📝',
        title: 'Typing the same details over and over',
        body: 'Having to manually enter complex item specs to Amazon, ASOS, and your own website is frustrating and leads to mistakes.',
      },
      {
        icon: '⏳',
        title: 'Sold out items are still online',
        body: 'When a size sells out in-store or online, it often takes hours or days to update on third-party sites. This leads to angry customers calling about inventory you no longer have.',
      },
      {
        icon: '📊',
  ...
  block3_features: {
    ...
    subheading:
      'ApparelGrid runs quietly in the background. It connects your main inventory software to the rest of the internet, so you don\'t have to touch it.',
    features: [
      {
        icon: '🔌',
      ...
      },
      {
        ...
        body: 'When you add a new item or change a price, we instantly update Amazon, ASOS, Facebook Marketplace, and your brand\'s website.',
      },
      {
        icon: '📈',
        title: 'Compare where your clothes sell fastest',
  ...
  block4_proof: {
    ...
    testimonial: {
      ...
      role: 'Independent Clothing Boutique',
    },
  },
  block5_cta: {
