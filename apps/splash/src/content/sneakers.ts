...
export const content: SplashContent = {
  meta: {
    title: 'SneakerGrid — Easy Inventory Management for Sneaker Boutiques',
    description:
      'SneakerGrid connects your inventory software to all your online listing sites automatically. See which sites sell your shoes and stop updating listings by hand.',
  },
  brand: {
    name: 'SneakerGrid',
    tagline: 'Simple inventory automation for sneaker boutiques',
    accentColor: '#dc2626', // red-600
    accentColorDark: '#991b1b', // red-800
    accentColorLight: '#fee2e2', // red-100
    accentColorGlow: 'rgba(220, 38, 38, 0.18)',
  },
  audience: {
    label: 'boutiques',
    industry: 'sneakers and streetwear',
    assetNoun: 'shoes',
    channelNoun: 'listings',
  },
  block1_hero: {
    eyebrow: 'Inventory Automation',
    headline: 'Get your sneakers online fast. We handle the rest.',
    subheadline:
      'SneakerGrid connects your inventory software directly to the sites where you sell sneakers and streetwear. When a pair arrives, it is listed automatically. When it sells, it is removed everywhere. No manual updates required.',
  ...
  block2_pain: {
    ...
    subheading:
      'Entering SKUs, sizes, conditions, and photos across multiple websites takes too much time, and making sure your listings are accurate is a constant headache.',
    painPoints: [
      {
        icon: '📝',
        title: 'Typing the same details over and over',
        body: 'Having to manually enter complex shoe specs to StockX, GOAT, eBay, and your own website is frustrating and leads to mistakes.',
      },
      {
        icon: '⏳',
        title: 'Sold shoes are still online',
        body: 'When a pair sells in-store, it often takes hours or days to remove it from third-party sites. This leads to angry customers calling about inventory you no longer have.',
      },
      {
        icon: '📊',
  ...
  block3_features: {
    ...
    subheading:
      'SneakerGrid runs quietly in the background. It connects your main inventory software to the rest of the internet, so you don\'t have to touch it.',
    features: [
      {
        icon: '🔌',
      ...
      },
      {
        ...
        body: 'When you add a new pair or change a price, we instantly update StockX, GOAT, eBay, and your boutique\'s website.',
      },
      {
        icon: '📈',
        title: 'Compare where your shoes sell fastest',
        body: 'We show you exactly how long your inventory stays on each site. You can finally see which platforms are actually helping you move pairs.',
      },
      {
        icon: '🗄️',
  ...
  block4_proof: {
    ...
    testimonial: {
      quote:
        'We used to spend hours re-typing SKUs and uploading photos to five different websites. Now we enter it once in our system, and it\'s everywhere. It just works.',
      author: 'Store Manager',
      role: 'Independent Sneaker Boutique',
    },
  },
  block5_cta: {
